...
<div class="bg-stone-100 flex flex-col ">
  ...
  <div class="flex justify-center items-center">
    <div class="mt-2 mx-4 w-full">
      ...
      <div class="mb-4 mt-4 w-full flex justify-center items-center">
        <HomeProduct {products} />
      </div>
      
      <div class="flex justify-center mt-4 mb-8">
        <a
        class="font-md bg-white text-sm text-gray-500 border p-2 rounded hover:text-primary hover:border-primary"
        href="/products"
        >
        View more
      </a>
