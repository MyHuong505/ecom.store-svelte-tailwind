...
<div class="flex w-full gap-2">
  ...
  <div class="relative flex items-center flex-1 h-56 sm:h-96">
    {#each banners as { link, text }, index}
      ...
      >
        <img src={link} alt={text} class="w-full h-96 rounded object-scale-down md:object-cover" />
      </div>
    {/each}
  ...
  <div class="w-1/3 flex-col hidden lg:flex">
    <img
